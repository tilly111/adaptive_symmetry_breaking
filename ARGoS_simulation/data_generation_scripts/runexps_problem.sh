...
exit
    ...
    MODEL=${3} # should be "compare" or "resample" or "compare_more_options"
	...
	EXP_TEMPLATE_SRC=ARGoS_simulation/experiment/kilobot_ark_${n}_options.argos
