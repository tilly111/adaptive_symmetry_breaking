...
public:
    ...
    void MoreTest(CKilobotEntity& c_kilobot_entity);
...
private:
    ...
    bool shuffle;
    // if we want to mimic global communication
    bool global;
    ...
    //Real m_fTimeForAMessage;  // TODO change back
    ...
    //UInt16 m_unEnvironmentPlotUpdateFrequency;  // TODO change back
