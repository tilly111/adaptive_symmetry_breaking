        ...
        switch( new_motion_type ){
            case FORWARD:
                if(!runtime_identification)
                    spinup_motors();
                if (calibrated){  // TODO shouldnt this always be true bc assigned to lines above?
                    if(!runtime_identification)
...
int main()
{
    ...
    // struct.
    debug_info_create();  // does the inital setup do drag information out of the simulation
    ////////////////////////////////////////
